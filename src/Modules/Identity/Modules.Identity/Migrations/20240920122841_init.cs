    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTypeInfos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    UserTypeInfoId = table.Column<byte>(type: "tinyint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_UserTypeInfos_UserTypeInfoId",
                        column: x => x.UserTypeInfoId,
                        principalSchema: "Identity",
                        principalTable: "UserTypeInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_UserTypeInfoId",
                schema: "Identity",
                table: "Users",
                column: "UserTypeInfoId");
